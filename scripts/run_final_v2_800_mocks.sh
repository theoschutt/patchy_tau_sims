...
do
    ...
    trash /home/theo/Documents/research/CMB/patchy_tau_sims/output/multi_mock_runs/hi-tsz+lens_final_v2_20mocks_eqsgn_${v_ext}/hi-tsz+lens_final_v2_20mocks_eqsgn_${v_ext}_*/output/thumbstack/tauring_filtarea.fits
    trash /home/theo/Documents/research/CMB/patchy_tau_sims/output/multi_mock_runs/hi-tsz+lens_final_v2_20mocks_eqsgn_${v_ext}/hi-tsz+lens_final_v2_20mocks_eqsgn_${v_ext}_*/output/thumbstack/tauring_filtmask.fits
    trash-empty
